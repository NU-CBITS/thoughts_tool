...
Dynamo.ManageCollectionView = Backbone.View.extend({
  ...
  //1)  it's models are the same model class 
  //    accepted by ManageCollectionView's collection.
  ...
  chooseExistingToAddAtIndex: function(element_index) {
    ...
    $popup.append( self.chooseExistingModelView.$el );
  ...
  onChoosingModelToAdd: function(chosen_element, element_index) {
    ...
    return this.addExistingAtIndex(element, element_index);
  },  
